...
*	[asctimetables.com](http://asctimetables.com/): Не учитывает требования СанПиН. В СанПине, например, рекоммендуют делать пн и пт более разгруженными по сравнению с остальными днями, делать физкультуру первым уроком и т.д. Дорогой.
*	[составительрасписания.рф](http://xn--80aaagprcbxxcslhbhchd6ruc.xn--p1ai/): Неудобный интерфейс. Программа устанавливается локально -> зависит от мощностей компьютера и в реалиях оборудования простой школы не справится с генерацией оптимального расписания.
...
[Демонстрация](https://disk.360.yandex.ru/d/OVyn3_VnotG9WA)
